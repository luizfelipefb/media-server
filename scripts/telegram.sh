...
then
  endpoint="10.0.1.2:8989/api/MediaCover/${sonarr_series_id}/poster-500.jpg?apiKey=${SONARR_APIKEY}"
  ...
  endpoint="10.0.1.2:7878/api/MediaCover/${radarr_movie_id}/poster-500.jpg?apiKey=${RADARR_APIKEY}"
